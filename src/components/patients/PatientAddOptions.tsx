...
import { FileType, Database, ArrowRight } from 'lucide-react';
...
const PatientAddOptions: React.FC<PatientAddOptionsProps> = ({ onSelectForm, onSelectEhr }) => {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Manual Form Entry</h3>
          <p className="text-gray-600 text-sm mb-4">
            Manually enter patient information using our comprehensive form. 
            This option allows you to input detailed clinical information.
          </p>
          <div className="flex justify-end mt-4">
            <button className="text-trialos-blue font-medium flex items-center text-sm">
              <span>Continue</span>
